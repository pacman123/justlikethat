...
import com.bytepunditz.Desktop.appertureEnablers.*;


public abstract class  AbstractCrawler {
	 private File outputFile;
	    
	    protected SimpleCrawlerHandler handler;
...
//	                }
	    ...
	    public static String getCommonExplanationPart() {
	        ...
	        writer.println(getAlignedOption(null) + "optional if --performance or --native is specified)");
